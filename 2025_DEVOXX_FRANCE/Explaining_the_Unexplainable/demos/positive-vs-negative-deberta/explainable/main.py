...
if __name__ == "__main__":
    review_text = "'Misery' was the best movie I've seen since I was a small boy"
    visualize_attributions(review_text)

    # review_text = "'Misery' was the bset moive I've seen snice I was a small boy"
    # visualize_attributions(review_text)

    review_text = "'Misery' was the bset moive I've seen snice me were a small boy"
    visualize_attributions(review_text)
