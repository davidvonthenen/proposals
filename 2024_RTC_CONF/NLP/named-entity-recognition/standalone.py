...
# Example sentence for NER detection
test_sentences = [
    "Microsoft is based in the United States of America.",
    ...
    "John Smith donated $5000 to the Red Cross during the 2020 pandemic.",
    "Her appointment is scheduled for 3 PM tomorrow at the downtown clinic.",
]
...
#     (".", ["O"]),
#     ("alice", ["B-NAME"]),
#     ("smith", ["I-NAME", "B-FAMILY_NAME"]),
#     ("and", ["O"]),
#     ("john", ["B-NAME"]),
#     ("doe", ["I-NAME", "B-FAMILY_NAME"]),
#     ("from", ["O"]),
#     ("stanford", ["B-ORGANIZATION", "B-LOCATION"]),
...
# merged_entities = merge_entities(tokens_with_tags)
# for entity_type, entity_text in merged_entities:
#     print(f"{entity_type}: {entity_text}")
# print("\n\n\n")

for sentence in test_sentences:
    # Detect named entities in the example sentence
